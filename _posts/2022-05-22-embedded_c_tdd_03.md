...
인터페이스가 테스트와 잘 맞추지고 나면 링크 오류가 발생합니다. 
그러면 뼈대 구현을 의도적으로 틀리게 추가합니다. 
만약 실패를 기대했는데 통과한다면 테스트 내부에 문제가 있음을 나타냅니다. 
...
『Agile in a Flash』[OL11]에서 팀 오팅거(Tim Ottinger)와 제프 랭거(Jeff Langr)는 단위 테스트의 5가지 중요한 속성을 정의하였습니다. 
테스트는 FIRST일 때 가장 효과적입니다. 
